...
#RUNNING
def menu1():
  menu= int(input("Enter the option to show (1-14 or 17-44): "))
  while menu < 1 and menu > 44 or menu >= 15 and menu <= 16 and menu != 99:
    menu= int(input("Invalid option, enter the option to show (1-14 or 17-44): "))
  else: 
    if menu == 1:
      triangle_area()
      print("")
